...
<ul class="settings-nav">
		...
		<li class="" id="bpanel3" name="bpanel3"><a href="javascript:wpdoctor_panels(3);"><?php _e("Suspicious files", "wpdoctor"); ?></a></li>
	...
	function scan($dir, $clean, $option) {
		...
		foreach($files as $file) {
			...
			if(is_file($dir.'/'.$file) && !in_array($dir.'/'.$file,$this->scanned_files)) {
				...
				if(strpos($file, ".php")!==false || strpos($file, ".tpl")!==false) $this->check(file_get_contents($dir.'/'.$file),$dir.'/'.$file, $clean);
